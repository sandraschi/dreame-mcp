...
4. Start the server:
   ...
   uv run python -m dreame_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn dreame_mcp.server:app --port 10894
   ```
...
5. Open `http://localhost:10894` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/dreame-mcp/issues) |
